...
Figure: Possible implementation of some functionality (`preliminary version <http://35.204.63.20:81/doc/Extension/Schematic_GPIO16_A_InformativeOnly.pdf>`_). 
...
External links:
  ...
  - `PDF 3D model <http://35.204.63.20:81/doc/Extension/RPEM_Template1_3Dmodel.pdf>`_
  - `3D STEP model <http://35.204.63.20:81/doc/Extension/RPEM_Template1_A_3D.step>`_
  - `Red Pitaya Extension Module Dimensions <http://35.204.63.20:81/doc/Extension/RPEM_Template1_Dimensions.pdf>`_
  - `PCB 3D image <http://35.204.63.20:81/doc/Extension/RPEM_Template1_Pcb3D.jpg>`_
  - `PCB 3D image top <http://35.204.63.20:81/doc/Extension/RPEM_Template1_PcbTop.jpg>`_
  - `GPIO16_A_Informative Schematic diagram <http://35.204.63.20:81/doc/Extension/Schematic_GPIO16_A_InformativeOnly.pdf>`_
  - `PCB option - forced air flow 3d image <http://35.204.63.20:81/doc/Extension/RPEM_Template2_Pcb3D.jpg>`_
  - `3D STEP option - forced air flow - model <http://35.204.63.20:81/doc/Extension/RPEM_Template2_A_3D.step>`_
  - `Altium project <http://35.204.63.20:81/doc/Extension/RPEM_Template.zip>`_